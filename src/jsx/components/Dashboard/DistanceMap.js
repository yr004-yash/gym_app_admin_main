...
const StatsRunningChart = loadable(() =>
  pMinDelay(import("../Gymove/DistanceMap/StatsRunningChart"), 1000)
);
const StatsCyclingChart = loadable(() =>
  pMinDelay(import("../Gymove/DistanceMap/StatsCyclingChart"), 1000)
);

const activitiesBlog = [
  {title:'Sunday Running'},
  {title:'Saturday Running'},
  {title:'Monday Running'},
];

const DistanceMap = () => {
  const [refreshToggle, setRefreshToggle] = useState(false);
  const [data, setData] = useState(activitiesBlog);
      ...
      <div className="col-xl-9 col-xxl-8">
        <div className="row">
          <div className="col-xl-12">
            <div className="card">
              <div className="card-header d-md-flex d-block pb-0 border-0">
                <div className="me-2 mb-md-0 mb-3">
                ...
                <div className="d-flex flex-wrap align-items-center">
                  ...
                  <div className="form-check custom-switch toggle-switch text-right mb-2">
                    <input
                      type="checkbox"
                      className="form-check-input"
                      id="customSwitch12"
          ...
          <div className="col-xl-12">
            <div className="card">
              <Tab.Container defaultActiveKey="Running">
                <div className="card-header d-sm-flex d-block pb-0 border-0">
                  ...
                  <div className="card-action card-tabs style-1 mt-2 mb-sm-0 mb-3 mt-sm-0">
      ...
      <div className="col-xl-3 col-xxl-4">
        <div className="row">
          <div className="col-xl-12 col-md-6">
            <div className="card">
              <div className="card-header border-0 pb-3 p-4">
                <div>
              ...
              <div className="card-body p-0 ">
                <div className="d-flex align-items-center bgl-primary p-4">
                  <svg
                    className="me-3"
                    width={51}
                    height={51}
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <rect width={51} height={51} rx="25.5" fill="#0B2A97" />
                    <g clipPath="url()">
                      <path
                ...
                <div className="d-flex flex-wrap p-4 pb-2">
          ...
          <div className="col-xl-12 col-md-6">
            <div className="card">
              ...
              >
                {data.map((item, ind)=>(
                  <div className="d-flex py-3 border-bottom align-items-center" key={ind}>
                    <span className="activity-icon bg-secondary me-3">
                      <svg
                        width={24}
                        height={24}
                        viewBox="0 0 24 24"
                    ...
                    <Link to="/personal-record" className="ms-auto">
                      <svg
                        width={24}
                        height={24}
                        viewBox="0 0 24 24"
                ...
                <div className="d-flex py-3 border-bottom align-items-center">
                  <span className="activity-icon bg-danger me-3">
                    <svg
                      width={24}
                      height={24}
                      viewBox="0 0 24 24"
