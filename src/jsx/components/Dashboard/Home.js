  ...
  return (
    <div className="row">
        ...
        <div className="card">
          <div className="card-header d-sm-flex d-block pb-0 border-0">
            <div className="me-auto pr-3 mb-sm-0 mb-3">
              <h4 className="text-black fs-20">Earnings</h4>
              <p className="fs-13 mb-0">
                Checkout your Earnings
              </p>
            </div>
            <Dropdown className="dropdown mb-3 show">
              <Dropdown.Toggle
                className="btn rounded i-false light"
              >
        ...
        <div className="row">
          ...
          <div className="col-xl-12">
            <div className="card">
              <div className="card-header d-sm-flex d-block pb-0 border-0">
                <div className="me-auto pr-3">
                  <h4 className="text-black fs-20 font-w600">Calories Chart</h4>
                  <p className="fs-13 mb-0 text-black">
                    Lorem ipsum dolor sit amet, consectetur
                  </p>
                </div>
                <Dropdown className="dropdown mt-sm-0 mt-3 select-drop-btn">
                  <Dropdown.Toggle type="button" className="btn rounded change-style">
                    {selectChange}
                  </Dropdown.Toggle>
                  <Dropdown.Menu className="dropdown-menu dropdown-menu-right">
                    {dropList.map((item, index)=>(
                      <Dropdown.Item key={index} onClick={()=>setSelectChange(item.title)}>{item.title}</Dropdown.Item>
                    ))}                    
                  </Dropdown.Menu>
                </Dropdown>
              </div>
      ...
      <div className="col-xl-3 col-xxl-4">
        <div className="row">
          <div className="col-xl-12">
            <div className="card featuredMenu">
              <div className="card-header border-0">
                <h4 className="text-black font-w600 fs-20 mb-0">
                  Featured Diet Menu
                </h4>
              </div>
