...
import { Tab, Dropdown, Nav } from "react-bootstrap";
                  ...
                  <Tab.Content className="card-body tab-content pt-2">
                    ...
                    >
                      <div className="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2 px-3">
                        <div className="col-xl-5 col-xxl-8 col-lg-6 col-sm-8 d-flex align-items-center">
                          <div className="list-icon bgl-primary me-3 mb-3">
                            <p className="fs-24 text-primary mb-0 mt-2">4</p>
                        ...
                        <div className="col-xl-2 col-xxl-4 col-lg-2 col-sm-4 activities mb-3 me-auto ps-3 pe-3 text-sm-center text-xl-end">
                          ...
                          <span className="text-warning ms-2">Running</span>
                        </div>
                        <div className="col-xl-5 col-xxl-12 col-lg-4 col-sm-12 d-flex align-items-center">
                          ...
                          <Dropdown className="dropdown mb-3">
                            <Dropdown.Toggle
                              variant=""                              
                              className="more-button i-false p-0"                              
                            >
                              <svg
                                width={6}
                                height={26}
                            ...
                            <Dropdown.Menu className="dropdown-menu dropdown-menu-right">
                              <Link className="dropdown-item" to="/workoutplan">
                                Edit
                              </Link>
                              <Link className="dropdown-item" to="/workoutplan">
                                Delete
                      ...
                      <div className="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2 px-3">
                        <div className="col-xl-5 col-xxl-8 col-lg-6 col-sm-8 d-flex align-items-center">
                          <div className="list-icon bgl-primary me-3 mb-3">
                            <p className="fs-24 text-primary mb-0 mt-2">5</p>
                        ...
                        <div className="col-xl-2 col-xxl-4 col-lg-2 col-sm-4 activities mb-3 me-auto ps-3 pe-3 text-sm-center text-xl-end">
                          ...
                          <span className="text-secondary ms-2">Yoga</span>
                        </div>
                        <div className="col-xl-5 col-xxl-12 col-lg-4 col-sm-12 d-flex align-items-center">
                          <Link
                            to="/workoutplan"
                      ...
                      <div className="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2 px-3">
                        <div className="col-xl-5 col-xxl-8 col-lg-6 col-sm-8 d-flex align-items-center">
                          <div className="list-icon bgl-primary me-3 mb-3">
                            <p className="fs-24 text-primary mb-0 mt-2">3</p>
                        ...
                        <div className="col-xl-2 col-xxl-4 col-lg-2 col-sm-4 activities mb-3 me-auto ps-3 pe-3 text-sm-center text-xl-end">
                          ...
                          <span className="text-info ms-2">Cycling</span>
                        </div>
                        <div className="col-xl-5 col-xxl-12 col-lg-4 col-sm-12 d-flex align-items-center">
                          <Link
                            to="/workoutplan"
                      ...
                      <div className="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2 px-3">
                        <div className="col-xl-5 col-xxl-7 col-lg-6 col-sm-7 d-flex align-items-center">
                          <div className="list-icon bg-light me-3 mb-3">
                            <p className="fs-24 text-black mb-0 mt-2">28</p>
                          ...
                          <div className="info mb-3">
                            ...
                            <span className="ps-3 pe-3">34Km</span>
                            <span>00:23:45”</span>
                          </div>
                        </div>
                        <div className="col-xl-2 col-xxl-3 col-lg-2 col-sm-3 activities mb-3 me-auto ps-3 pe-3 text-sm-center text-xl-end col-6">
                          <svg
                            width={24}
                            height={24}
                            viewBox="0 0 24 24"
                        ...
                        <div className="col-xl-5 col-xxl-2 col-lg-4 col-sm-2 d-flex align-items-center col-6">
                          <Dropdown className="dropdown more-dropdown mb-3">
                            <Dropdown.Toggle
                              variant=""
                              className="more-button i-false p-0"
                      ...
                      <div className="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2 px-3">
                        <div className="col-xl-5 col-xxl-7 col-lg-6 col-sm-7 d-flex align-items-center">
                          <div className="list-icon bg-light me-3 mb-3">
                            <p className="fs-24 text-black mb-0 mt-2">18</p>
              ...
              <div className="card flex-xl-column flex-md-row flex-column">
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex mb-4 align-items-center">
                    <span className="date-icon me-3">3</span>
                    <div>
                      <h6 className="fs-16">
                        <Link to="/workoutplan" className="text-black">
                          Cardio Exercise
                        </Link>
                      </h6>
                  ...
                  <div className="d-flex mb-4 align-items-center">
                    <span className="date-icon me-3">5</span>
                    <div>
                      <h6 className="fs-16">
                        <Link to="/workoutplan" className="text-black">
                          Cycling Routine
                  ...
                  <div className="d-flex mb-4 align-items-center">
                    <span className="date-icon me-3">16</span>
                    <div>
                      <h6 className="fs-16">
                        <Link to="/workoutplan" className="text-black">
                          Cycling Routine
