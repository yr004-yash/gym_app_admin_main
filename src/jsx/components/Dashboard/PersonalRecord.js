    ...
    <div className="row">
        ...
        <div className="card">
          <div className="card-body">
            <div className="row align-items-center">
              <div className="col-xl-5 col-xxl-12 me-auto">
                <div className="d-sm-flex d-block align-items-center">
                  <img src={illustration} alt="" className="mw-100 me-3" />
                  <div>
                    <h4 className="fs-20 text-black">
                      Generate your workout report for now{" "}
                    </h4>
              ...
              <div className="col-xl-7 col-xxl-12 mt-3">
                <Link
                  to="/workoutplan"
                  className="btn btn-outline-primary btn-md mb-2"
                >
                  May 28th, 2023
                  <i className="las la-calendar ms-3 scale5" />
                </Link>
                <svg
                  className="ms-2 me-2"
                  width={14}
                ...
                <Link
                  to="/workoutplan"
                  className="btn btn-outline-primary me-3 btn-md  mb-2"
                >
                  June 28th, 2023
                  <i className="las la-calendar ms-3 scale5" />
                </Link>
                <Link to="/workoutplan" className="btn btn-primary btn-md mb-2">
                  Generate Report
                  <i className="las la-angle-right ms-3 scale5" />
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="card">
          <div className="card-header bg-white">
            <div className="d-flex me-3 align-items-center">
              <span className="p-sm-3 p-2 me-sm-3 me-2 rounded-circle bg-secondary">
                <svg
                  width={32}
                  height={32}
                  viewBox="0 0 32 32"
              ...
              <h4 className="fs-20 text-black mb-0">Running</h4>
            </div>
            <Dropdown className="dropdown">
              <Dropdown.Toggle
                variant=""
                type="button"
                className="btn btn-primary i-false light btn-md"               
              >
                Newest
                <i className="fa fa-chevron-down ms-2" aria-hidden="true" />
              </Dropdown.Toggle>
              <Dropdown.Menu className="dropdown-menu">
                <Link className="dropdown-item" to="/personal-record">
                  Edit
                </Link>
                <Link className="dropdown-item" to="/personal-record">
                  Delete
          ...
          <div className="card-body p-0">
            <div className="table-responsive">
              <table className="table shadow-hover">
                ...
                <tbody>
                  {runningTableData.map((item, index)=>(
                    <tr key={index}>
                      <td>
                        <p className="text-black mb-1">{item.title}</p>
                        <span className="fs-14">October {`${index+1}`}, 2023</span>
                      </td>
                      <td>
                        <p className="text-black mb-1">14,2 Km</p>
                        <span className="fs-14">Target 15Km</span>
                      </td>
                      <td>
                        <p className="text-black mb-1">00:53:22”</p>
                        <span className="fs-14">Target 40mins</span>
                      </td>
                    </tr>
                  ))}                 
                </tbody>
      ...
      <div className="col-xl-4 col-xxl-6 col-lg-6">
        <div className="card">
          <div className="card-header bg-white">
            <div className="d-flex me-3 align-items-center">
              <span className="p-sm-3 p-2 me-sm-3 me-2 rounded-circle bg-danger">
                <svg
                  width={32}
                  height={32}
                  viewBox="0 0 30 30"
              ...
              <h4 className="fs-20 text-black mb-0">Cycling</h4>
            </div>
            <Dropdown className="dropdown">
              <Dropdown.Toggle
                variant=""
                ...
                <tbody>
                  {runningTableData.map((item, index)=>(
                    <tr key={index}>
                      <td>
                        <p className="text-black mb-1">{item.title}</p>
                        <span className="fs-14">October {`${index+7}`}, 2023</span>
                      </td>
                      <td>
                        <p className="text-black mb-1">14,2 Km</p>
                        <span className="fs-14">Target 15Km</span>
        ...
        <div className="card">
          <div className="card-header bg-white">
            <div className="d-flex align-items-center me-3">
              <span className="p-sm-3 p-2 me-sm-3 me-2 rounded-circle bg-warning">
                <svg
                  width={32}
                  height={32}
                  viewBox="0 0 30 30"
              ...
              <h4 className="fs-20 text-black mb-0">Yoga</h4>
            </div>
            <Dropdown className="dropdown">
              <Dropdown.Toggle
                variant=""
