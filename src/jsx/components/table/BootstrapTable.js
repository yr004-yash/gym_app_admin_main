                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span className="badge bg-success">Tax</span>
                    </td>
                    <td>January 30</td>
                  ...
                  <tr>
                    ...
                    <td>                      
                      <span className="badge bg-warning">Extended</span>
                    </td>
                    <td>January 25</td>
                    <td className="text-danger">$14.85</td>
                  </tr>
                </tbody>
              </Table>
            </Card.Body>
              ...
              <Table responsive bordered>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>Kolor Tea Shirt For Women</td>
                    <td>                      
                      <span className="badge badge-success light">Tax</span>
                    </td>
                    <td>January 30</td>
                    <td className="color-success">$55.32</td>
                  </tr>
                  <tr>
                    ...
                    <td>Blue Backpack For Baby</td>
                    <td>                      
                      <span className="badge badge-danger light">Extended</span>
                    </td>
                    <td>January 25</td>
                    <td className="text-danger">$14.85</td>
                  </tr>
              ...
              <Table responsive hover className="header-border verticle-middle">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>                      
                      <span className="badge badge-primary light">70%</span>
                    </td>
                  </tr>
                  <tr>
                    <th>2</th>
                    ...
                    <td>                      
                      <span className="badge badge-success light">70%</span>
                    </td>
                  </tr>
                  <tr>
                    <th>3</th>
                    ...
                    <td>                      
                      <span className="badge badge-dark light">70%</span>
                    </td>
                  </tr>
                  <tr>
                    <th>4</th>
                    ...
                    <td>                      
                      <span className="badge badge-danger light">70%</span>
                    </td>
                  </tr>
                  <tr>
                    <th>5</th>
                    ...
                    <td>                      
                      <span className="badge badge-warning light">70%</span>
                    </td>
                  </tr>
                </tbody>
              </Table>
                    ...
                    <td>
                      <span>
                        <Link
                          ...
                          title="Edit"
                        >
                          <i className="fas fa-pen color-muted"></i>{" "}
                        </Link>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span className="badge badge-info light">Shiped</span>
                    </td>
                    <td>CN</td>
                  </tr>
                  <tr>
                    ...
                    <td>$38.00</td>
                    <td>                      
                      <span className="badge badge-danger light">Shipped</span>
                    </td>
                    <td>AU</td>
                  </tr>
                  <tr>
