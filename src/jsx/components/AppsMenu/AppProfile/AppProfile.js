			...
			<div className="col-xl-4">
				<div className="row">
					...
					<div className="col-lg-12">
						<div className="card">
							<div className="card-header border-0 pb-0">
								<h4 className="text-primary">Today Highlights</h4>
							</div>	
					...
					<div className="col-lg-12">
						<div className="card">
							<div className="card-header border-0 pb-0">
								<h4 className="text-primary ">Interest</h4>
							</div>
							<div className="card-body pt-3">
					...
					<div className="col-lg-12">
						<div className="card">
							<div className="card-header border-0 pb-0">
								<h4 className="text-primary">Our Latest News</h4>
							</div>	
							<div className="card-body pt-3">
								...
								<Tab.Pane id="my-posts"  eventKey='Posts'>
									<div className="my-post-content pt-3">
										<div className="post-input">
											...
											<Link to="/app-profile" className="btn btn-primary light px-3 me-2"  onClick={() => dispatch({type:'linkModal'})}>
			  ...
			  <Modal show={state.camera}  className="modal fade" id="cameraModal" onHide={() => dispatch({type:'cameraModal'})} centered>
				<div className="modal-content">
					<div className="modal-header">
						...
						<button type="button" className="btn-close"  onClick={() => dispatch({type:'cameraModal'})}>
							
						</button>
					</div>
					<div className="modal-body">
						<div className="input-group mb-3 flex-nowrap">
							<span className="input-group-text rounded-sm">Upload</span>
			  ...
			  <Modal   show={state.reply}  className="modal fade" id="replyModal" onHide={()=>dispatch({type:'replyModal'})} centered>
				<div className="modal-content">
					<div className="modal-header">
						...
						<button type="button" className="btn-close"  onClick={() => dispatch({type:'replyModal'})}>
