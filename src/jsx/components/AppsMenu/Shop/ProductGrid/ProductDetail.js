                  ...
                  <Tab.Container defaultActiveKey="All">
                    <div className="card-header d-block pb-0 border-0">
                      ...
                      <Nav className="nav nav-tabs diet-tabs" id="nav-tab" role="tablist" >
                        <Nav.Link eventKey="All"  className="btn btn-warning me-2 mb-2"> All Products</Nav.Link>

                        <Nav.Link eventKey="Lunch"  className="btn btn-warning light mb-2">Add Product</Nav.Link>
                      </Nav>                   
                    
                      <Tab.Content className=" diet-content">
                        <Tab.Pane className="" eventKey={'All'}>
                          <DietProduct onClick={() => setModalToggle(true)} />
                        </Tab.Pane>
                        
                        <Tab.Pane className="" eventKey={'Lunch'}>
                          <AddProduct onClick={() => setModalToggle(true)} />
                        </Tab.Pane>
