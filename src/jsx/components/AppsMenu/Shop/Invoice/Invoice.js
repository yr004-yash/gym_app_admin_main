        ...
        <div className="col-lg-12">
          <div className="card">
            <div className="card-header">
              {" "}
              Invoice <strong>01/10/2023</strong>{" "}
                ...
                <div className="col-lg-4 col-sm-5 ms-auto">
                  <table className="table table-clear">
                    <tbody>
                      ...
                      <tr>
                        <td className="left">
                          <strong className="text-black">Discount (20%)</strong>
                        </td>
                        <td className="right">$1,699,40</td>
                      </tr>
                      <tr>
                        <td className="left">
                          <strong className="text-black">VAT (10%)</strong>
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="right">
                          <strong className="text-black">$7.477,36</strong>
                          <br />
                          <strong className="text-black">0.15050000 BTC</strong>
                        </td>
                      </tr>
                    </tbody>
                  </table>
